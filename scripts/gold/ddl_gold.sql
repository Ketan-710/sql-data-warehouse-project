...
================================================================================
Purpose:
    Create business-ready views in the Gold Layer using the transformed and
...
ON pn.cat_id = pc.id
WHERE prd_end_dt IS NULL;  -- Filtered out the historical data 
